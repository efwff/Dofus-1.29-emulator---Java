...
import com.codebreak.login.database.account.exception.NotBannedException;
import com.codebreak.login.persistence.tables.records.AccountRecord;

public final class Banned extends AccountOperationWrap {
	public Banned(final Operation<AccountRecord> origin) {
		super(origin);
	}
	@Override
