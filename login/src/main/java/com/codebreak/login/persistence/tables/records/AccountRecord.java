...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record15<Long, String, String, String, Integer, Timestamp, Timestamp, String, Timestamp, Timestamp, Boolean, String, String, String, Boolean> {

    private static final long serialVersionUID = 645755570;
    ...
    /**
     * Setter for <code>codebreak_login.account.Connected</code>.
     */
    ...
    /**
     * Getter for <code>codebreak_login.account.Connected</code>.
     */
     ...
     */
    @Override
    public Row15<Long, String, String, String, Integer, Timestamp, Timestamp, String, Timestamp, Timestamp, Boolean, String, String, String, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row15<Long, String, String, String, Integer, Timestamp, Timestamp, String, Timestamp, Timestamp, Boolean, String, String, String, Boolean> valuesRow() {
     ...
     */
    @Override
    public AccountRecord values(Long value1, String value2, String value3, String value4, Integer value5, Timestamp value6, Timestamp value7, String value8, Timestamp value9, Timestamp value10, Boolean value11, String value12, String value13, String value14, Boolean value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Long id, String name, String nickname, String password, Integer power, Timestamp creationdate, Timestamp lastconnectiondate, String lastconnectionip, Timestamp remainingsubscription, Timestamp banneduntil, Boolean banned, String secretquestion, String secretanswer, String email, Boolean connected) {
        super(Account.ACCOUNT);
